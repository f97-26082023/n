export default {
    ...
    'dataExport': {
        'defaultExportFilename': 'goFire_export_data',
        'exportFilename': 'goFire_{nickname}_export_data'
    },
    'datetime': {
        'AM': {
            'upperCase': 'SÁNG'
    ...
    'Welcome to n.f97.xyz': 'Chào mừng đến với n.f97.xyz',
    'Please log in with your n.f97.xyz account': 'Vui lòng đăng nhập bằng tài khoản n.f97.xyz của bạn',
    ...
    'Expense By Primary Category': 'Chi Theo Mục Chính',
    'Expense By Secondary Category': 'Chi Theo Mục Phụ',
    'Income Chart': 'Biểu Đồ Thu Nhập',
    'Income By Account': 'Thu Nhập Theo Tài Khoản',
    'Income By Primary Category': 'Thu Theo Mục Chính',
    'Income By Secondary Category': 'Thu Theo Mục Phụ',
